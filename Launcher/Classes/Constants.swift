...
enum Constants {
    enum Strings {
        ...
        static let wrongDeviceSetup = "Please provide device IP and bundle identifier of your application. It can be configured under 'Configure Device' settings.".localized
    }
